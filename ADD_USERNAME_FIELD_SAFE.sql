-- =====================================================
-- SIMPLE USERNAME FIELD ADDITION (DEPENDENCY SAFE)
-- =====================================================
-- This script safely adds the username field without dependency issues
...
-- =====================================================
-- 3. SAFELY UPDATE THE HANDLE_NEW_USER FUNCTION
-- =====================================================
...
BEGIN
    ...
    AND trigger_name IN ('on_auth_user_created', 'trigger_new_user');
...
-- Create or replace the function (this handles dependencies better)
...
BEGIN
    ...
    RAISE NOTICE '3. Updated handle_new_user() function safely';
