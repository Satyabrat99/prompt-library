...
import FeaturedCollectionsManagement from "./pages/admin/FeaturedCollectionsManagement";
...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      // Prevent refetching when window regains focus (unless data is stale)
      refetchOnWindowFocus: true,
      // Prevent refetching when reconnecting to network
      ...
      gcTime: 10 * 60 * 1000,
      // Retry failed requests more times
      retry: 2,
